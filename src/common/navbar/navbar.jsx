  ...
  <div className="container-fluid justify-content-between">
    <div className="d-flex">
      ...
      <form className="input-group w-auto my-auto d-none d-sm-flex search" >
        ...
        <input autoComplete="off" type="search" className="form-control rounded searchField" placeholder="Search" style={{minWidth: '361px'}} />
      </form>
    </div>
 
    <ul className="navbar-nav flex-row">
      <li className="nav-item me-3 me-lg-1">
        <a className="profile nav-link d-sm-flex align-items-sm-center" href="#">
          ...
          <div><span className="userName">John Doe</span></div>
        </a>
      </li>
